...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img0" src="/pages/images/screenshots/013_dialogs/dialog_10.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img1" src="/pages/images/screenshots/013_dialogs/dialog_10_term.png" alt="Current example terminal output">		<!-- img#, filename -->
...
<div class="inpage-frame">
	<figure class="left">
		<img src="/pages/images/diagrams/013_dialog/dialog_10_grid_diagram.png" alt="Simple guide to laying out a dialog" style="size: 75%;">
		<figcaption>
