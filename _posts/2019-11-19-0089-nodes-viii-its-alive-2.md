...
<div class="inpage-frame">
	<figure class="left">
		<img src="/pages/images/diagrams/023_nodes/node_offset.png" alt="Figure 1: Offset: the distance (x/y) from the node origin to the mouse pointer at the time it was clicked" style="width: 229px; height: 199px;">
		<figcaption>
