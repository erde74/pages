...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img0" src="/pages/images/screenshots/017_mvc/mvc_12.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img1" src="/pages/images/screenshots/017_mvc/mvc_12_term.png" alt="Current example terminal output">		<!-- img#, filename -->
