...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img0" src="/pages/images/screenshots/018_cairo/cairo_09.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img1" src="/pages/images/screenshots/018_cairo/cairo_09_term.png" alt="Current example terminal output">		<!-- img#, filename -->
...
<div class="inpage-frame">
	<figure class="center">
		<img src="/pages/images/diagrams/018_cairo/degrees_radians_clockwise.png" alt="Figure 1: Degrees and Radians, Clockwise" style="width: 600px; height: 600px;" class="center">
		<figcaption>
...
<div class="screenshot-frame">
	...
	<div class="frame-screenshot">
		<figure>
			<img id="img2" src="/pages/images/screenshots/018_cairo/cairo_10.png" alt="Current example output">		<!-- img# -->
	...
	<div class="frame-terminal">
		<figure class="right">
			<img id="img3" src="/pages/images/screenshots/018_cairo/cairo_10_term.png" alt="Current example terminal output"> 		<!-- img#, filename -->
